const BusinessTeamsSection = () => {
  const features = [
    ...
    },
    {
      ...
      icon: "M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 012 2v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a2 2 0 012-2h2z",
    },
    {
      title: "Finance",
      description:
        "Audit-proof software built for critical financial operations like month-end close and quarterly budgeting.",
      icon: "M10 18a8 8 0 100-16 8 8 0 000 16zm1-13a1 1 0 10-2 0v.092a4.535 4.535 0 00-1.676.662C6.602 6.234 6 7.009 6 8c0 .99.602 1.765 1.324 2.246.",
    },
    {
      title: "Enterprise Design",
      description:
        "Craft beautiful, delightful experiences for both marketing and product with real cross-company collaboration.",
      icon: "M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1z",
    },
    {
      title: "Operations",
      description:
      ...
      icon: "M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.",
    },
  ];
...
export default BusinessTeamsSection;
